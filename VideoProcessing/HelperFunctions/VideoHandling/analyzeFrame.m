...
function [wet_frac,overlay_img] = analyzeFrame(input_vid,analys,fnum,params)
    ...
    scaled_mask = analys.scaled_mask; 
    ...
    [overlay_img,wet_frac] = getFilmOverlay(crop,scaled_mask,area_mask,cam_mask,max_area,fnum,area_fnum,seed_rc); % get wet film mask from area frame
...
function [overlay,wet_frac] = getFilmOverlay(RGB_img,scaled_mask,area_mask,cam_mask,max_area,fnum,area_fnum,seed_rc)  
