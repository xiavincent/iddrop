...
%% FUNCTION:
function [area_mask, outer_region, shadow_mask, film_area] = setAreas(video,crop_rect,area_frame_num,area_fit_type)
    ...
    [area_mask, outer_region, shadow_mask, film_area] = userdrawROI(area_frame_cropped,area_fit_type); % Handle our ROI drawing
end