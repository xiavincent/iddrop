...
%% FUNCTION:
function [area_mask, film_area, shadow_mask, shadow_area, film_center, film_radius] = setAreas(video,crop_rect,area_frame_num,area_fit_type)
    ...
    [area_mask, film_area, shadow_mask, shadow_area, film_center, film_radius] = userdrawROI(area_frame_cropped,area_fit_type); % Handle our ROI drawing
end